  ...
  <div class="container">
    ...
    <div v-if="isReviewing && !isOverviewing">
      <div class="review-card">
        ...
        <el-row>
          <el-col :span="24">
            <preview subject="practice" :stuNum="currentStudent.id"></preview>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    getSheetData() {
      // 获得science表所有数据
      // axios.get("http://localhost:18080/api/practice/getAllList")
      //     .then(res => {
    ...
    clean(rawData) {
      ...
      this.result.forEach((student) => {
        ...
        if (summary && summary.pra !== null) {
          student.score = summary.pra;
