...
export default {
  ...
  mounted() {
    ...
    if (this.rawData !== null) {
      // 暂时取1,26,27测试
      axios.get("http://localhost:18080/api/service/list?ids=1%2C26%2C27%2C4%2C5%2C6%2C7%2C8%2C9%2C10")
          .then(res => {
...
//     if (this.rawData !== null) {
//       // 暂时取1,26,27测试
//       axios.get("http://localhost:18080/api/practice/list?ids=1%2C26%2C27%2C4%2C5%2C6%2C7%2C8%2C9%2C10")
//           .then(res => {
//             this.rawData = res.data.data
//             this.clean(this.rawData);
//           });
